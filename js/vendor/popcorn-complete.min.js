...
h=Object.prototype,e=f.forEach,n=f.slice,u=h.hasOwnProperty,q=h.toString,x=m.Popcorn,v=[],o=false,z={events:{hash:{},apis:{}}},I=function(){return m.requestAnimationFrame||m.webkitRequestAnimationFrame||m.mozRequestAnimationFrame||m.oRequestAnimationFrame||m.msRequestAnimationFrame||function(a){m.setTimeout(a,16)}}(),E={put:function(a){for(var c in a)if(a.hasOwnProperty(c))this[c]=a[c]}},g=function(a,c){return new g.p.init(a,c||null)};g.version="a4f6ef4";g.isSupported=true;g.instances=[];g.p=g.prototype=
...
K.onTime(function(){if(!r.ended&&!r.seeking){r.currentTime=K.getPosition();y.dispatchEvent("timeupdate")}});K.onSeek(I);K.onPlay(function(){if(!r.ended)if(S){S=false;if(r.autoplay||!r.paused){r.paused=false;v(a);o()}else{p=H=true;K.pause(true)}}else if(p){p=false;w=true;K.pause(true)}else a()});K.onBufferChange(c);K.onComplete(j);K.play(true)}function g(N){var T={name:"MediaError"};T.message=N.message;T.code=N.code||5;r.error=T;y.dispatchEvent("error")}function F(N){if(y._canPlaySrc(N)){var T=y._util.parseUri(N).queryKey;
r.controls=T.controls=T.controls||r.controls;r.src=N;if(b()){if(L)L&&K&&K.destroy();jwplayer(D.id).setup({file:N,width:"100%",height:"100%",controls:r.controls});K=jwplayer(D.id);K.onReady(E);K.onError(g);jwplayer.utils.log=function(G,V){if(typeof console!=="undefined"&&typeof console.log!=="undefined")V?console.log(G,V):console.log(G);G==="No suitable players found and fallback enabled"&&g({message:G,code:4})};r.networkState=y.NETWORK_LOADING;y.dispatchEvent("loadstart");y.dispatchEvent("progress")}else f(function(){F(N)})}else{r.error=
{name:"MediaError",message:"Media Source Not Supported",code:MediaError.MEDIA_ERR_SRC_NOT_SUPPORTED};y.dispatchEvent("error")}}function A(N){r.currentTime=N;if(B){O();K.seek(N)}else v(function(){O();K.seek(N)})}function O(){r.seeking=true;if(r.paused)p=true;y.dispatchEvent("seeking")}function a(){r.paused=false;if(M){M=false;if(r.loop&&!Q||!r.loop){Q=true;y.dispatchEvent("play")}y.dispatchEvent("playing")}}function c(){y.dispatchEvent("progress")}function l(){r.paused=true;if(!M){M=true;y.dispatchEvent("pause")}}
function j(){if(r.loop)A(0);else{r.ended=true;l();y.dispatchEvent("timeupdate");y.dispatchEvent("ended")}}function s(N){r.volume=N;if(B){K.setVolume(r.volume*100);y.dispatchEvent("volumechange")}else v(function(){s(r.volume)})}function t(N){r.muted=N;if(B){K.setMute(N);y.dispatchEvent("volumechange")}else v(function(){t(r.muted)})}if(!i.postMessage)throw"ERROR: HTMLJWPlayerVideoElement requires window.postMessage";var y=new m._MediaElementProto,D=typeof x==="string"?k.querySelector(x):x,r={src:e,
networkState:y.NETWORK_EMPTY,readyState:y.HAVE_NOTHING,seeking:false,autoplay:e,preload:e,controls:false,loop:false,poster:e,volume:1,muted:false,currentTime:0,duration:NaN,ended:false,paused:true,error:null},L=false,w=false,p=false,B=false,Q=false,K,M=true,C=[],S=true,H=false;y._eventNamespace=m.guid("HTMLJWPlayerVideoElement::");y.parentNode=D;y._util.type="JWPlayer";y.play=function(){y.dispatchEvent("play");r.paused=false;if(B){if(r.ended){A(0);r.ended=false}K.play(true)}else v(function(){y.play()})};
y.pause=function(){r.paused=true;B?K.pause(true):v(function(){y.pause()})};Object.defineProperties(y,{src:{get:function(){return r.src},set:function(N){N&&N!==r.src&&F(N)}},autoplay:{get:function(){return r.autoplay},set:function(N){r.autoplay=y._util.isAttributeSet(N)}},loop:{get:function(){return r.loop},set:function(N){r.loop=y._util.isAttributeSet(N)}},width:{get:function(){return y.parentNode.offsetWidth}},height:{get:function(){return y.parentNode.offsetHeight}},currentTime:{get:function(){return r.currentTime},
set:function(N){A(N)}},duration:{get:function(){return K.getDuration()}},ended:{get:function(){return r.ended}},paused:{get:function(){return r.paused}},seeking:{get:function(){return r.seeking}},readyState:{get:function(){return r.readyState}},networkState:{get:function(){return r.networkState}},volume:{get:function(){return r.volume},set:function(N){if(N<0||N>1)throw"Volume value must be between 0.0 and 1.0";s(N)}},muted:{get:function(){return r.muted},set:function(N){t(y._util.isAttributeSet(N))}},
error:{get:function(){return r.error}},buffered:{get:function(){return{start:function(N){if(N===0)return 0;throw"INDEX_SIZE_ERR: DOM Exception 1";},end:function(N){if(N===0){N=K.getDuration();if(!N)return 0;return N*(K.getBuffer()/100)}throw"INDEX_SIZE_ERR: DOM Exception 1";},length:1}}}});y._canPlaySrc=m.HTMLJWPlayerVideoElement._canPlaySrc;y.canPlayType=m.HTMLJWPlayerVideoElement.canPlayType;return y}var e="",n=false,u=false,q=[];m.HTMLJWPlayerVideoElement=function(x){return new h(x)};m.HTMLJWPlayerVideoElement._canPlaySrc=
function(){return"probably"};m.HTMLJWPlayerVideoElement.canPlayType=function(){return"probably"}})(Popcorn,window,document);(function(m,i){function k(h){this.startTime=0;this.currentTime=h.currentTime||0;this.duration=h.duration||NaN;this.playInterval=null;this.paused=true;this.playbackRate=this.defaultPlaybackRate=1;this.ended=h.endedCallback||m.nop}function d(h){function e(a){A.push(a)}function n(){if(!E)return 0;return g.currentTime}function u(a){if(a!==n())if(E){F.seeking=true;o.dispatchEvent("seeking");g.seekTo(a);F.ended=false;F.seeking=false;o.dispatchEvent("timeupdate");o.dispatchEvent("seeked");o.dispatchEvent("canplay");
...
data:C})})});p.bind(SC.Widget.Events.FINISH,function(){O({type:"finish"})});L=true;p.getDuration(I)}function z(){p.bind(SC.Widget.Events.PLAY_PROGRESS,function(C){p.setVolume(0);if(C.currentPosition>0){p.unbind(SC.Widget.Events.PLAY_PROGRESS);p.bind(SC.Widget.Events.PAUSE,function(){p.unbind(SC.Widget.Events.PAUSE);p.setVolume(1);p.bind(SC.Widget.Events.SEEK,function(){p.unbind(SC.Widget.Events.SEEK);o()});p.seekTo(0)});p.pause()}});p.play()}function I(C){C/=1E3;var S=r.duration;if(S!==C){r.duration=
C;t.dispatchEvent("durationchange");if(isNaN(S)){r.networkState=t.NETWORK_IDLE;r.readyState=t.HAVE_METADATA;t.dispatchEvent("loadedmetadata");t.dispatchEvent("loadeddata");r.readyState=t.HAVE_FUTURE_DATA;t.dispatchEvent("canplay");r.readyState=t.HAVE_ENOUGH_DATA;t.dispatchEvent("canplaythrough");for(C=B.length;C--;){B[C]();delete B[C]}r.paused&&r.autoplay&&t.play()}}}function E(C){function S(){r.seeking=true;t.dispatchEvent("seeking");p.seekTo(C)}r.currentTime=C;C*=1E3;L?S():addMediaReadyCallback(S)}
...
p.unbind(SC.Widget.Events.SEEK);p.unbind(SC.Widget.Events.FINISH);y.removeChild(D);D=k.createElement("iframe")}if(d()){L=false;SC.get("/resolve",{url:C},function(S){var H;if(S.errors){H={name:"MediaError"};if(S.errors[0])if(S.errors[0].error_message==="404 - Not Found"){H.message="Video not found.";H.code=MediaError.MEDIA_ERR_NETWORK}r.error=H;t.dispatchEvent("error")}D.id=m.guid("soundcloud-");D.width=r.width;D.height=r.height;D.frameBorder=0;D.webkitAllowFullScreen=true;D.mozAllowFullScreen=true;
...
c.volume;g(0)}else{c.muted=0;g(c.muted)}else{c.muted=w?1:0;u(function(){F(w)})}}if(!i.postMessage)throw"ERROR: HTMLVimeoVideoElement requires window.postMessage";var A=new m._MediaElementProto,O=typeof n==="string"?m.dom.find(n):n,a=k.createElement("iframe"),c={src:h,networkState:A.NETWORK_EMPTY,readyState:A.HAVE_NOTHING,seeking:false,autoplay:h,preload:h,controls:false,loop:false,poster:h,volume:1,muted:0,currentTime:0,duration:NaN,ended:false,paused:true,error:null},l=false,j=m.guid("player_"),
s,t=true,y=[],D,r,L=0;A._eventNamespace=m.guid("HTMLVimeoVideoElement::");A.parentNode=O;A._util.type="Vimeo";A.play=function(){c.paused=false;l?s.play():u(function(){A.play()})};A.pause=function(){c.paused=true;l?s.pause():u(function(){A.pause()})};Object.defineProperties(A,{src:{get:function(){return c.src},set:function(w){if(w&&w!==c.src)if(A._canPlaySrc(w)){c.src=w;if(l)if(l&&s){clearInterval(r);s.pause();i.removeEventListener("message",I,false);O.removeChild(a);a=k.createElement("iframe")}l=
false;w=A._util.parseUri(w);var p=w.queryKey,B,Q=["api=1","player_id="+j,"title=0","byline=0","portrait=0"];c.loop=p.loop==="1"||c.loop;delete p.loop;c.autoplay=p.autoplay==="1"||c.autoplay;delete p.autoplay;w=e+"/video/"+/\d+$/.exec(w.path)+"?";for(B in p)p.hasOwnProperty(B)&&Q.push(encodeURIComponent(B)+"="+encodeURIComponent(p[B]));w+=Q.join("&");a.id=j;a.style.width="100%";a.style.height="100%";a.frameBorder=0;a.webkitAllowFullScreen=true;a.mozAllowFullScreen=true;a.allowFullScreen=true;O.appendChild(a);
...
Z=U=false;G.currentTime=0;W=[];clearInterval(aa);clearInterval(ba);R.stopVideo();R.clearVideo();R.destroy();T=k.createElement("div")}}else{I(function(){D(J)});return}N.appendChild(T);var P=H._util.parseUri(J).queryKey;delete P.v;G.autoplay=P.autoplay==="1"||G.autoplay;delete P.autoplay;G.loop=P.loop==="1"||G.loop;delete P.loop;P.rel=P.rel||0;P.modestbranding=P.modestbranding||1;P.iv_load_policy=P.iv_load_policy||3;P.disablekb=P.disablekb||1;P.showinfo=P.showinfo||0;var ea=i.location.protocol==="file:"?
"*":i.location.protocol+"//"+i.location.host;P.origin=P.origin||ea;P.controls=P.controls||G.controls?2:0;G.controls=P.controls;P.wmode=P.wmode||"opaque";if(P.html5!==0)P.html5=1;J=u.exec(J)[1];m.getJSONP("https://gdata.youtube.com/feeds/api/videos/"+J+"?v=2&alt=jsonc&callback=?",function(X){if(X.error)console.warn("failed to retreive duration data, reason: "+X.error.message);else if(X.data){G.duration=X.data.duration;H.dispatchEvent("durationchange");R=new YT.Player(T,{width:"100%",height:"100%",
wmode:P.wmode,videoId:J,playerVars:P,events:{onReady:F,onError:A,onStateChange:y}});G.networkState=H.NETWORK_LOADING;H.dispatchEvent("loadstart");H.dispatchEvent("progress")}else console.warn("failed to retreive duration data, reason: no response data")})}else f(function(){D(J)})}else{G.error={name:"MediaError",message:"Media Source Not Supported",code:MediaError.MEDIA_ERR_SRC_NOT_SUPPORTED};H.dispatchEvent("error")}}function r(){var J=R.getCurrentTime();if(G.seeking)q(J-G.currentTime)<1&&Q();else{if(q(G.currentTime-
J)>e){B();Q()}G.currentTime=J}}function L(){var J=R.getVideoLoadedFraction();if(J&&$!==J){$=J;H.dispatchEvent("progress")}}function w(J){if(J!==G.currentTime){G.currentTime=J;if(U){B();R.seekTo(J)}else I(function(){B();R.seekTo(J)})}}function p(){H.dispatchEvent("timeupdate")}function B(){l("pause",g);j("pause",M);G.seeking=true;H.dispatchEvent("seeking")}function Q(){G.ended=false;G.seeking=false;H.dispatchEvent("timeupdate");H.dispatchEvent("seeked");H.dispatchEvent("canplay");H.dispatchEvent("canplaythrough")}
function K(){if(G.ended){w(0);G.ended=false}da=setInterval(p,H._util.TIMEUPDATE_MS);G.paused=false;if(Y){Y=false;if(G.loop&&!Z||!G.loop){Z=true;H.dispatchEvent("play")}H.dispatchEvent("playing")}}function M(){G.paused=true;if(!Y){Y=true;clearInterval(da);H.dispatchEvent("pause")}}function C(){if(G.loop){w(0);H.play()}else{G.ended=true;M();l("play",E);j("play",K);H.dispatchEvent("timeupdate");H.dispatchEvent("ended")}}function S(J){G.muted=J;if(U){R[J?"mute":"unMute"]();H.dispatchEvent("volumechange")}else I(function(){S(G.muted)})}
if(!i.postMessage)throw"ERROR: HTMLYouTubeVideoElement requires window.postMessage";var H=new m._MediaElementProto,N=typeof z==="string"?k.querySelector(z):z,T=k.createElement("div"),G={src:n,networkState:H.NETWORK_EMPTY,readyState:H.HAVE_NOTHING,seeking:false,autoplay:n,preload:n,controls:false,loop:false,poster:n,volume:1,muted:false,currentTime:0,duration:NaN,ended:false,paused:true,error:null},V=false,U=false,Z=false,R,Y=true,W=[],ca=-1,ba,$=0,aa,da;H._eventNamespace=m.guid("HTMLYouTubeVideoElement::");
H.parentNode=N;H._util.type="YouTube";l("buffering",t);l("ended",C);H.play=function(){G.paused=false;U?R.playVideo():I(function(){H.play()})};H.pause=function(){G.paused=true;if(U){g();R.pauseVideo()}else I(function(){H.pause()})};Object.defineProperties(H,{src:{get:function(){return G.src},set:function(J){J&&J!==G.src&&D(J)}},autoplay:{get:function(){return G.autoplay},set:function(J){G.autoplay=H._util.isAttributeSet(J)}},loop:{get:function(){return G.loop},set:function(J){G.loop=H._util.isAttributeSet(J)}},
...
0||J>1)throw"Volume value must be between 0.0 and 1.0";G.volume=J;if(U){R.setVolume(G.volume*100);H.dispatchEvent("volumechange")}else I(function(){H.volume=J})}},muted:{get:function(){return G.muted},set:function(J){S(H._util.isAttributeSet(J))}},error:{get:function(){return G.error}},buffered:{get:function(){return{start:function(J){if(J===0)return 0;throw"INDEX_SIZE_ERR: DOM Exception 1";},end:function(J){if(J===0){if(!G.duration)return 0;return G.duration*$}throw"INDEX_SIZE_ERR: DOM Exception 1";
},length:1}},configurable:true}});H._canPlaySrc=m.HTMLYouTubeVideoElement._canPlaySrc;H.canPlayType=m.HTMLYouTubeVideoElement.canPlayType;return H}var e=10,n="",u=/^.*(?:\/|v=)(.{11})/,q=Math.abs,x=false,v=false,o=[];m.HTMLYouTubeVideoElement=function(z){return new h(z)};m.HTMLYouTubeVideoElement._canPlaySrc=function(z){return/(?:http:\/\/www\.|http:\/\/|www\.|\.|^)(youtu).*(?:\/|v=)(.{11})/.test(z)?"probably":n};m.HTMLYouTubeVideoElement.canPlayType=function(z){return z==="video/x-youtube"?"probably":
